    ...
    <div className="bg-card border-t border-accent/30 p-4">
      <div className="max-w-3xl mx-auto flex flex-col">
        <div className="flex items-center space-x-3">
          <button 
            className={`${isListening ? 'bg-secondary/30 animate-pulse' : 'bg-primary/10 hover:bg-primary/20'} transition-colors text-primary p-2 rounded-full`}
